...
# arguments <- data.frame(fire_path = "/mnt/sharc/shared/sudlab1/General/projects/SynthUTR_hepG2_a549/a549_motif_analysis/one_transcript/fire_residual.txt_FIRE/RNA/fire_residual_lowstab.signif.motifs.temp",
